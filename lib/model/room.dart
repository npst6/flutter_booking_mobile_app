...
class Room {
  String nameRoom; String idRoom; String startDay; String endDay; int numberRoom;
  int numberAdults; int numberChild; String address; String city;
  double discount; String desc; int status; String createDay;
  double money; String idHotel; String urlImage; List<int> service;

  Room({
    this.nameRoom, this.idRoom, this.startDay, this.endDay, this.numberRoom,
    this.numberAdults, this.numberChild, this.address, this.city,
    this.discount, this.desc, this.status, this.createDay,
